...
let _ =
  Js.export "slang"
    (object%js
       ...
       method interp3_code str = Js.string (wrap (fun x -> (Interp_3.string_of_code  (Interp_3.compile (frontend x)))) str)
       method jargon_code  str = Js.string (wrap (fun x -> (Jargon.string_of_listing (Jargon.compile (frontend x)))) str)
     end)
